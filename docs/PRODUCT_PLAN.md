...
打造一个以 **“地点发现 → 用户筛选 → AI 排程 → 地图路线 → 局部调整”** 为核心流程的 AI 旅行规划网页版。

产品不是“生成旅行攻略的聊天机器人”，而是：

> **AI 驱动的可视化旅行规划工作台。**

用户真正操作的是结构化旅行计划；AI 负责理解需求、推荐地点、排程和提出修改；地图服务负责地点解析、坐标、真实路线和交通时间。
...
↓
Refine
  用户确定性编辑或使用受控 AI Proposal，并手动刷新路线
```
...
> **先发现并选择你真正想去的地方，再让 AI 帮你把它们安排成一趟合理的旅行。**
...
> **一个以地图和结构化行程为核心，让用户先选择想去的地方，再由 AI 帮助排程、优化和局部调整的旅行规划工作台。**
