...
export default function App() {
  ...
  const updatePlace = async (placeId: string, changes: PlaceEditChanges) => {
    await runPlanCommand({ type: "update_place", placeId, changes });
  };
  const removeCandidate = async (candidateId: string, cascade: boolean) => {
    await runPlanCommand(cascade ? { type: "remove_candidate_tree", candidateId } : { type: "remove_candidate", candidateId });
