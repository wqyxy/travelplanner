...
export const ACTION_REGISTRY_V3: readonly ActionRegistrationV3[] = [
  ...
  { id: "itinerary.replan", stage: "itinerary", executor: A, promptId: "action.itinerary.replan", reasoning: "high", reasoningSummary: "none", web: "disabled", inputContract: "itinerary.action.input", outputContract: "itinerary.replan.output", scopePolicy: "itinerary", resultPolicy: "save_result" },
