...
export const PROMPT_REGISTRY_V3: readonly PromptRegistrationV3[] = [
  ...
  { id: "action.itinerary.generate", relativePath: "actions/itinerary/生成行程.md", kind: "action", stage: "destinations", reasoning: "high", reasoningSummary: "none", web: "disabled", outputContract: "itinerary.generate.output" },
  { id: "action.itinerary.replan", relativePath: "actions/itinerary/重新规划行程.md", kind: "action", stage: "destinations", reasoning: "high", reasoningSummary: "none", web: "disabled", outputContract: "itinerary.replan.output" },
  { id: "action.itinerary.detail.generate", relativePath: "actions/itinerary/生成每日详细行程.md", kind: "action", stage: "itinerary", reasoning: "high", reasoningSummary: "none", web: "disabled", outputContract: "itinerary.detail.generate.output" },
  { id: "action.itinerary.detail.update", relativePath: "actions/itinerary/更新每日详细行程.md", kind: "action", stage: "itinerary", reasoning: "high", reasoningSummary: "none", web: "disabled", outputContract: "itinerary.detail.update.output" },
...
export const ACTION_REGISTRY_V3: readonly ActionRegistrationV3[] = [
  ...
  { id: "requirements.capture", stage: "requirements", executor: D, inputContract: "requirements.capture.input", outputContract: "deterministic.result", scopePolicy: "trip-facts", resultPolicy: "deterministic_apply" },
  ...
  { id: "itinerary.generate", stage: "destinations", executor: A, promptId: "action.itinerary.generate", reasoning: "high", reasoningSummary: "none", web: "disabled", timeoutMs: 240_000, inputContract: "itinerary.action.input", outputContract: "itinerary.generate.output", scopePolicy: "itinerary", resultPolicy: "save_result" },
  { id: "itinerary.replan", stage: "destinations", executor: A, promptId: "action.itinerary.replan", reasoning: "high", reasoningSummary: "none", web: "disabled", inputContract: "itinerary.action.input", outputContract: "itinerary.replan.output", scopePolicy: "itinerary", resultPolicy: "save_result" },
  { id: "itinerary.detail.generate", stage: "itinerary", executor: A, promptId: "action.itinerary.detail.generate", reasoning: "high", reasoningSummary: "none", web: "disabled", inputContract: "itinerary.action.input", outputContract: "itinerary.detail.generate.output", scopePolicy: "itinerary", resultPolicy: "save_result" },
  { id: "itinerary.detail.update", stage: "itinerary", executor: A, promptId: "action.itinerary.detail.update", reasoning: "high", reasoningSummary: "none", web: "disabled", inputContract: "itinerary.action.input", outputContract: "itinerary.detail.update.output", scopePolicy: "itinerary", resultPolicy: "proposal_required" },
