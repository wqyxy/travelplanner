...
async function setup() {
  ...
  plan.days = [{ id: "d1", dayNumber: 1, date: null, title: "Day", transferMode: "drive", detailLevel: "planned", detailStatus: null, startAnchor: { id: "a1", placeId: "p1", label: null, notes: null }, stops: [{ id: "s1", candidateId: null, placeId: "p2", activity: "visit", period: null, startTime: null, endTime: null, durationMinutes: null, transportFromPrevious: null, scheduleVerification: null, costNote: null, costVerification: null, notes: null }], endAnchor: { id: "a2", placeId: "p2", label: null, notes: null } }];
