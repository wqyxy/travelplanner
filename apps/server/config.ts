...
export type UiSettings = { workspaceSplitRatio: number; theme: "light" | "dark"; requirementsPanelOpen: boolean; mapCategoryColors: MapCategoryColors };
...
export const defaultConfig = (): AppConfig => ({ version: 1, port: 6688, ui: { workspaceSplitRatio: .52, theme: "light", requirementsPanelOpen: true, mapCategoryColors: { ...mapCategoryColorDefaults } }, ai: { model: "", reasoningEffort: "medium" } });
